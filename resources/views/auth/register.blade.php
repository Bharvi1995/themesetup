...
<body oncontextmenu="return false">
                ...
                <div class="col-md-4 col-xl-4 col-xxl-4 offset-md-4 offset-xl-4 offset-xxl-4 content-body">
                    <div class="row content-box-form">
                        ...
                        <div class="col-md-12 form-contant-right">
                            ...
                            <!-- <p class="text-center">Please furnish all necessary information to officially register your business with us.</p> -->
                            <form action="{{ route('applynow-store') }}" id="signup-form" method="post">
                                ...
                                <div class="form-group mt-1">
                                    ...
                                    <div class="input-group rounded-input form-password-toggle">
                                        <input type="password" class="form-control" placeholder="Enter here" name="password" id="password" autocomplete="off">
                                ...
                                <div class="form-group mt-1">
                                    ...
                                    <div class="input-group rounded-input form-password-toggle">
                                        ...
                                        <span id="pwd-show-confirm" class="input-group-text cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye font-small-4"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg></span>
                                    </div> 
    ...
    <script>
        ...
        $('#pwd-show-confirm').on('click', function () {
            var pwd = $('#password_confirmation').attr('type');
            if(pwd == 'password'){
