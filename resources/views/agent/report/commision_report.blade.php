                        ...
                        <table class="table table-borderless table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="min-width: 170px;"> Amount </th>
                                    <th class="text-center" style="min-width: 230px;"> Commission</th>
                                    ...
                                    @foreach ($arr_t_data as $item)
                                        ...
                                        @foreach ($item as $k => $_item)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $_item->OtherSuccessAmount." ".$_item->currency }}</td>
