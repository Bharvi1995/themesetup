...
@section('breadcrumbTitle')
    <a href="{{ route('rp.dashboard') }}">Dashboard</a> /Payments List
@endsection
                    ...
                    <div class="modal-body">
                        <div class="basic-form">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="order_no">Transaction Number</label>
                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <a href="{{ route('rp-merchant-transactions', ['type' => 'xlsx'] + request()->all()) }}"
                            class="btn btn-primary btn-sm mx-1" id="ExcelLink"><i class="fa fa-download mr-2"></i> Export Excel</a>
                    </div>
                </div>
                <div class="card-body">
                    <?php
