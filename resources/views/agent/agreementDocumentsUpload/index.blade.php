...
<body class="h-100">
                                            ...
                                            <form class="" action="{{ route('rp-agreement-documents-upload') }}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <p class="mb-0 text-red">Note: Signed agreement size must be less than 35mb.</p>
                                                        @if ($errors->has('files'))
                                                            <p class="text-red">
    ...
    ***********************************-->
    ...
    <script src="{{ storage_asset('themeAdmin/custom_js/front/transactionDocumentsUpload.js') }}"></script>
</body>
