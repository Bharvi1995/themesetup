...
@section('title')
Add Refund for AI Global
@endsection
@section('breadcrumbTitle')
<a href="{{ route('admin.dashboard') }}">Dashboard</a> /Add Refund for AI Global
@endsection
        ...
        <div class="iq-card border-card">
            <div class="iq-card-header bg-info d-flex justify-content-between">
                <div class="iq-header-title">
                    <h4 class="card-title">Add Refund for AI Global</h4>
                </div>
                <a href="{{ route('admin-user.index') }}" class="btn btn-primary btn-xs rounded"> <i
                        class="fa fa-arrow-left" aria-hidden="true"></i></a>
            </div>
            <div class="iq-card-body">
                {!! Form::open(array('route' => 'aiglobal.refund.store' , 'method' => 'post','id'=>'admin-form')) !!}
                <div class="row">
                    <div class="col-lg-6">
