...
@section('breadcrumbTitle')
    <a href="{{ route('dashboardPage') }}">Dashboard</a> / Payouts
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <h4 class="mt-50">Payouts List</h4>
        </div>
                            ...
                            <tbody>
                                @if (count($data) > 0)
                                    ...
                                    if($count > 0){
                                        for($i=0;$i<$count;$i++){
                                            ?>
                                                <li><a target="_blank" href="{{ getS3Url($files[$i]) }}"> <i class="fa fa-file text-warning"></i></a></li>
                                                <?php
                                        }
                                    }
                                    ?>
