<div class="row">
    <div class="col-md-12">
        ...
        <span class="text-danger">Kindly upload below documents for the retrieval transactions as requested by the
            acquiring bank: <br>
        </span>
        <ul>
        ...
        <hr>
        <form action="{{ route('transaction-documents-upload-edit') }}" method="POST" enctype="multipart/form-data"
            class="form-dark">
            @csrf
            <input type="hidden" name="transaction_id" value="{{ $id }}">
            <input type="hidden" name="files_for" value="retrieval">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger btn-sm remove-record"
                                            ...
                                            data-url="{{ route('retrieval-document-delete', $data['transaction_id']) }}"
                                            data-id="{{ $value }}">
                                            Delete
                                        </a>
                                    </td>
