    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('wl-merchant-store') }}" method="post" enctype="multipart/form-data"
                        class="form-dark">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control" name="is_login_wl_merchant">
                                            <option value="1"
                                                {{ old('is_login_wl_merchant') == '1' ? 'selected' : '' }}>Yes</option>
                                            <option value="0"
                                                {{ old('is_login_wl_merchant') == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div class="input-div">
                                            {!! Form::select(
                                                ...
                                                [isset($data->business_type) ? $data->business_type : old('business_type')],
                                            ...
                                            <tbody id="tab_logic">
                                                        ...
                                                        <tr data-id={{ $key == 0 ? $key + 1 : $key }}>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                @else
                                                                    ...
                                                                    <button type="button"
                                                                        class="btn btn-danger minus btn-sm">
                                                ...
                                                @else
                                                    ...
                                                    <tr data-id="1">
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-danger btn-sm plus"> <i
                                                                    class="fa fa-plus"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
                                            ...
                                            <tbody id="tab_logic_ip">
                                                ...
                                                @else
                                                    ...
                                                    <tr data-id="1">
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-danger btn-sm plus-ip">
                                                                <i class="fa fa-plus"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
    ...
    <script type="text/javascript">
        ...
        $("body").on('click', '.plus-ip', function() {
            ...
            $("#tab_logic_ip").append(
				...
				<td class="text-center">
					<button type="button" class="btn btn-danger plus-ip"> <i class="fa fa-plus"></i>
					</button>
