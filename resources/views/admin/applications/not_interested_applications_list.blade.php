...
@section('breadcrumbTitle')
    <nav aria-label="breadcrumb">
       <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Not Interested Management</li>
       </ol>
       <h6 class="font-weight-bolder mb-0">Not Interested Management</h6>
    </nav>
@endsection
        ...
        <div class="col-lg-6 text-right">
            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.exportAllNotInterested', request()->all()) }}"
                    data-filename="Not_Interested_Application" class="btn btn-outline-primary btn-sm" id="ExcelLink"> Export Excel </a>
            @endif
            ...
            <div class="card  mt-1">
                <div class="card-header d-flex justify-content-between">
                    <div class="card-title">
                        <h5 class="card-title">Not Interested Applications</h5>
                    </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive custom-table">
                        <table id="not_interested_applications_list" class="table table-borderless">
                            <thead>
                                <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                                                        ...
                                                        @endif
                                                        @if (auth()->guard('admin')->user()->can(['update-application']))
                                                            <li><a href="{{ route('change.notInterest.app', $value->id) }}"
                                                                class="dropdown-item">
                                                                Restore
                                                            </a></li>
                                                        @endif
