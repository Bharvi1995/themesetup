...
@section('breadcrumbTitle')
    <nav aria-label="breadcrumb">
       <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Rate Accepted Applications</li>
       </ol>
       <h6 class="font-weight-bolder mb-0">Rate Accepted Applications</h6>
    </nav>
@endsection
                            ...
                            <div class="row ">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select name="technology_partner_id" id="technology_partner" data-size="7"
                                        data-live-search="true" class="form-select btn-primary fill_selectbtn_in own_selectbox"
                                        data-width="100%">
                                        <option selected disabled>Select here</option>
        ...
        <div class="col-lg-6 text-right">
            @if (auth()->guard('admin')->user()->can(['export-application']))
                <a href="{{ route('admin.applications.rate_accepted.export', request()->all()) }}"
                    data-filename="Rate_Accepted_Merchants_" class="btn btn-outline-primary btn-sm" id="ExcelLink"> Export Excel </a>
            @endif
            ...
            <div class="card  mt-1">
                <div class="card-header d-flex justify-content-between">
                    <div class="card-title">
                        <h5 class="card-title">Rate Accepted Applications</h5>
                    </div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive custom-table">
                        <table id="approved_applications_list" class="table table-borderless">
                            <thead>
                                <tr>
