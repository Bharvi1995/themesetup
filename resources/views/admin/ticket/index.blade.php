            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="card-header-toolbar align-items-center">
                        ...
                        <a href="{{ route('admin.ticket') }}" class="btn btn-danger btn-sm" style="border-radius: 0px 5px 5px 0px !important;">Clear</a>
                        </div>
                    </div>
                </div>
                                ...
                                @if (count($tickets) > 0)
                                    @foreach ($tickets as $ticket)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">{{ $ticket->title }}</td>
                                            <td class="align-middle text-center text-sm">{{ Str::limit($ticket->body, 50) }}</td>
                                            <td class="align-middle text-center text-sm">{{ convertDateToLocal($ticket->created_at, 'd-m-Y') }}
                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                @if ($ticket->status == 0)
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                                                        ...
                                                        <li>
                                                            <a href="{!! URL::route('admin.ticket.show', [$ticket->id]) !!}" class="dropdown-item">View</a>
                                                        </li>
                                                        @endif
