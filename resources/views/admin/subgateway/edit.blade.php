...
@section('breadcrumbTitle')
    ...
    <a href="{{ route('admin.subgateway.index', ['gateway_id' => $gateway->id]) }}"> Sub Gateway </a> / Edit
@endsection
@section('content')
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="header-title">
                        <h4 class="card-title">Sub Gateway Edit</h4>
                    </div>
                ...
                <div class="card-body">
                    {!! Form::model($subgateway, [
                        'route' => ['admin.subgateway.update', $gateway->id, $subgateway->id],
                        'method' => 'PATCH',
