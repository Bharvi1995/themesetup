                    ...
                    <div class="custom-tab-1">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                <div class="pt-4">
                                    {{ Form::model($data, ['route' => ['merchant-user-update', $data->id], 'method' => 'put', 'class' => 'form-dark']) }}
                                    {!! csrf_field() !!}
                                            ...
                                            <div class="row">
                                                <div class="col-xl-6 col-md-12 col-sm-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        @if ($errors->has('name'))
                                                            <span class="help-block text-danger font-red-mint">
                                                ...
                                                <div class="col-xl-6 col-md-12 col-sm-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        @endif
                                                        <small>The password must contain: One Upper, Lower, Numeric and
