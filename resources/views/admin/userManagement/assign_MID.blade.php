...
@section('breadcrumbTitle')
    <nav aria-label="breadcrumb">
       <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Assign MID</li>
       </ol>
       <h6 class="font-weight-bolder mb-0">Assign MID</h6>
    </nav>
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="custom-tab-1">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('assign-mid', $data->id) }}"> MID Info</a>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <div class="basic-form">
                                        <div class="row ">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-select" name="mid" id="mid_id" data-size="7"
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-select" name="multiple_mid[]" id="multiple_mid_id"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-select select2Master" name="multiple_mid_master[]"
