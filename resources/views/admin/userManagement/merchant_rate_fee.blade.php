...
@section('breadcrumbTitle')
    <nav aria-label="breadcrumb">
       <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Rates/Fees</li>
       </ol>
       <h6 class="font-weight-bolder mb-0">Rates/Fees</h6>
    </nav>
@endsection
                ...
                <div class="card-body">
                    ...
                    <div class="custom-tab-1">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('merchant-rate-fee', $data->id) }}"> Merchant Rate/Fee</a>
                            </li>
                            <li class="nav-item">
