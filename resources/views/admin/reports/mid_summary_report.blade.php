...
@section('breadcrumbTitle')
    <nav aria-label="breadcrumb">
       <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li class="breadcrumb-item text-sm text-dark active" aria-current="page">MID Summary Report</li>
       </ol>
       <h6 class="font-weight-bolder mb-0">MID Summary Report</h6>
    </nav>
@endsection
@section('content')
    <?php
    ...
    <div class="row">
        ...
        <div class="col-md-8 text-right">
            ...
            <a href="{{ route('mid-summary-report', ['for' => 'Monthly']) }}" type="button" class="btn {{ isset($_GET['for']) && $_GET['for'] == 'Monthly' ? 'btn-secondary' : 'btn-primary' }}">Monthly</a>
                                                ...
                                                @if (count($transactions_summary) > 0)
                                                    @foreach ($transactions_summary as $mid_transaction)
                                                        ...
                                                        @foreach ($mid_transaction as $transaction)
                                                            <tr>
                                                                @if ($k == 0)
                                                                    <td class="align-middle text-center text-sm">{{ $transaction['bank_name'] }}<br>({{ '$ ' . $usd_amount }})
                                                                    </td>
                                                                @else
