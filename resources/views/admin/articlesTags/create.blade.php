...
<div id="section_one">
    <div class="heading-title">
        <h3> Create Article Tag </h3>
    </div>
</div>
{!! Form::open(array('route' => 'article-tags.store','method'=>'POST','class' => 'form form-horizontal','id'=>'articletag-form')) !!}
<div class="common-section mb-5">
   <div class="col-xl-12 col-sm-12 col-md-12 col-12">
      <div class="heading-title mb-4">
            <h3 class="mb-0" > Create Article Tag </h3>
