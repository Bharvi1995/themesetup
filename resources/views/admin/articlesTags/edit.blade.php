...
<div id="section_one">
    <div class="heading-title">
        <h3> Article Tag Edit Form </h3>
    </div>
</div>
{{ Form::model($tags, array('route' => array('article-tags.update', $tags->id), 'method' => 'PUT', 'class' => 'form form-horizontal','id'=>'articletag-form')) }}
<div class="common-section mb-5">
   <div class="col-xl-12 col-sm-12 col-md-12 col-12">
      <div class="heading-title mb-4">
            <h3 class="mb-0" > Article Tag Edit </h3>
            <a href="{{ route('article-tags.index') }}" class="btn btn-yellow">Back</a>
      </div>
...
<script type="text/javascript">
    $('#articletag-form').submit(function(){
