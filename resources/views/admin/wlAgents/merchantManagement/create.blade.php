...
@section('title')
    White Label RP Merchant Management Create
@endsection

@section('breadcrumbTitle')
    <a href="{{ route('admin.dashboard') }}">Dashboard</a> / <a href="{{ route('wl-agents.index') }}">White Label RP</a> / <a
        href="{{ route('wl-agent-merchant', $id) }}">Merchant Management</a> / Create
@endsection
        ...
        <div class="col-lg-12">
            <div class="card  mt-1">
                <div class="card-header">
                    ...
                    <a href="{{ route('wl-agent-merchant', $id) }}" class="btn btn-primary btn-sm"><i
                            class="fa fa-arrow-left"></i>
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('wl-agent-merchant-store') }}" method="post" enctype="multipart/form-data"
                        class="form-dark">
                        ...
                        @endif
                        {!! csrf_field() !!}
                        <input type="hidden" name="wl_rp_id" value="{{ $id }}">
                        <div class="row">
                            <div class="col-lg-6">
                                        ...
                                        <div class="main-select-phone d-flex justify-content-between align-items-center">
                                            <select class="select2 btn-primary fill_selectbtn_in own_selectbox"
                                                ...
                                                <option data-countryCode="DZ"
                                                    {{ old('country_code') == '213' ? 'selected' : '' }} value="213">
                                                    Algeria (+213)</option>
                                                <option data-countryCode="AD"
                                                    {{ old('country_code') == '376' ? 'selected' : '' }} value="376">
                                                    Andorra (+376)</option>
                                                <option data-countryCode="AO"
                                                    {{ old('country_code') == '244' ? 'selected' : '' }} value="244">
                                                    Angola (+244)</option>
                                                <option data-countryCode="AI"
                                                    {{ old('country_code') == '1264' ? 'selected' : '' }} value="1264">
                                                    Anguilla (+1264)</option>
                                                <option data-countryCode="AG"
                                                    {{ old('country_code') == '1268' ? 'selected' : '' }} value="1268">
                                                    Antigua &amp; Barbuda (+1268)</option>
                                                <option data-countryCode="AR"
                                                    {{ old('country_code') == '54' ? 'selected' : '' }} value="54">
                                                    Argentina (+54)</option>
                                                <option data-countryCode="AM"
                                                    {{ old('country_code') == '374' ? 'selected' : '' }} value="374">
                                                    Armenia (+374)</option>
                                                <option data-countryCode="AW"
                                                    {{ old('country_code') == '297' ? 'selected' : '' }} value="297">
                                                    Aruba
                                                    (+297)</option>
                                                <option data-countryCode="AU"
                                                    {{ old('country_code') == '61' ? 'selected' : '' }} value="61">
                                                    Australia (+61)</option>
                                                <option data-countryCode="AT"
                                                    {{ old('country_code') == '43' ? 'selected' : '' }} value="43">
                                                    Austria
                                                    (+43)</option>
                                                <option data-countryCode="AZ"
                                                    {{ old('country_code') == '994' ? 'selected' : '' }} value="994">
                                                    Azerbaijan (+994)</option>
                                                <option data-countryCode="BS"
                                                    {{ old('country_code') == '1242' ? 'selected' : '' }} value="1242">
                                                    Bahamas (+1242)</option>
                                                <option data-countryCode="BH"
                                                    {{ old('country_code') == '973' ? 'selected' : '' }} value="973">
                                                    Bahrain (+973)</option>
                                                <option data-countryCode="BD"
                                                    {{ old('country_code') == '880' ? 'selected' : '' }} value="880">
                                                    Bangladesh (+880)</option>
                                                <option data-countryCode="BB"
                                                    {{ old('country_code') == '1246' ? 'selected' : '' }} value="1246">
                                                    Barbados (+1246)</option>
                                                <option data-countryCode="BY"
                                                    {{ old('country_code') == '375' ? 'selected' : '' }} value="375">
                                                    Belarus (+375)</option>
                                                <option data-countryCode="BE"
                                                    {{ old('country_code') == '32' ? 'selected' : '' }} value="32">
                                                    Belgium
                                                    (+32)</option>
                                                <option data-countryCode="BZ"
                                                    {{ old('country_code') == '501' ? 'selected' : '' }} value="501">
                                                    Belize (+501)</option>
                                                <option data-countryCode="BJ"
                                                    {{ old('country_code') == '229' ? 'selected' : '' }} value="229">
                                                    Benin
                                                    (+229)</option>
                                                ...
                                                <option data-countryCode="BT"
                                                    {{ old('country_code') == '975' ? 'selected' : '' }} value="975">
                                                    Bhutan (+975)</option>
                                                <option data-countryCode="BO"
                                                    {{ old('country_code') == '591' ? 'selected' : '' }} value="591">
                                                    Bolivia (+591)</option>
                                                <option data-countryCode="BA"
                                                    {{ old('country_code') == '387' ? 'selected' : '' }} value="387">
                                                    Bosnia Herzegovina (+387)</option>
                                                <option data-countryCode="BW"
                                                    {{ old('country_code') == '267' ? 'selected' : '' }} value="267">
                                                    Botswana (+267)</option>
                                                <option data-countryCode="BR"
                                                    {{ old('country_code') == '55' ? 'selected' : '' }} value="55">
                                                    Brazil
                                                    (+55)</option>
                                                <option data-countryCode="BN"
                                                    {{ old('country_code') == '673' ? 'selected' : '' }} value="673">
                                                    Brunei (+673)</option>
                                                <option data-countryCode="BG"
                                                    {{ old('country_code') == '359' ? 'selected' : '' }} value="359">
                                                    Bulgaria (+359)</option>
                                                <option data-countryCode="BF"
                                                    {{ old('country_code') == '226' ? 'selected' : '' }} value="226">
                                                    Burkina Faso (+226)</option>
                                                <option data-countryCode="BI"
                                                    {{ old('country_code') == '257' ? 'selected' : '' }} value="257">
                                                    Burundi (+257)</option>
                                                <option data-countryCode="KH"
                                                    {{ old('country_code') == '855' ? 'selected' : '' }} value="855">
                                                    Cambodia (+855)</option>
                                                <option data-countryCode="CM"
                                                    {{ old('country_code') == '237' ? 'selected' : '' }} value="237">
                                                    Cameroon (+237)</option>
                                                ...
                                                <option data-countryCode="CV"
                                                    {{ old('country_code') == '238' ? 'selected' : '' }} value="238">
                                                    Cape
                                                ...
                                                <option data-countryCode="CF"
                                                    {{ old('country_code') == '236' ? 'selected' : '' }} value="236">
                                                    Central African Republic (+236)</option>
                                                <option data-countryCode="CL"
                                                    {{ old('country_code') == '56' ? 'selected' : '' }} value="56">
                                                    Chile
                                                    (+56)</option>
                                                <option data-countryCode="CN"
                                                    {{ old('country_code') == '86' ? 'selected' : '' }} value="86">
                                                    China
                                                    (+86)</option>
                                                <option data-countryCode="CO"
                                                    {{ old('country_code') == '57' ? 'selected' : '' }} value="57">
                                                    Colombia (+57)</option>
                                                <option data-countryCode="KM"
                                                    {{ old('country_code') == '269' ? 'selected' : '' }} value="269">
                                                    Comoros (+269)</option>
                                                <option data-countryCode="CG"
                                                    {{ old('country_code') == '242' ? 'selected' : '' }} value="242">
                                                    Congo
                                                    (+242)</option>
                                                <option data-countryCode="CK"
                                                    {{ old('country_code') == '682' ? 'selected' : '' }} value="682">
                                                    Cook
                                                    Islands (+682)</option>
                                                <option data-countryCode="CR"
                                                    {{ old('country_code') == '506' ? 'selected' : '' }} value="506">
                                                    Costa
                                                    Rica (+506)</option>
                                                <option data-countryCode="HR"
                                                    {{ old('country_code') == '385' ? 'selected' : '' }} value="385">
                                                    Croatia (+385)</option>
                                                <option data-countryCode="CU"
                                                    {{ old('country_code') == '53' ? 'selected' : '' }} value="53">
                                                    Cuba
                                                    (+53)</option>
                                                ...
                                                <option data-countryCode="CY"
                                                    {{ old('country_code') == '357' ? 'selected' : '' }} value="357">
                                                    Cyprus South (+357)</option>
                                                <option data-countryCode="CZ"
                                                    {{ old('country_code') == '42' ? 'selected' : '' }} value="42">
                                                    Czech
                                                    Republic (+42)</option>
                                                <option data-countryCode="DK"
                                                    {{ old('country_code') == '45' ? 'selected' : '' }} value="45">
                                                    Denmark
                                                    (+45)</option>
                                                <option data-countryCode="DJ"
                                                    {{ old('country_code') == '253' ? 'selected' : '' }} value="253">
                                                    Djibouti (+253)</option>
                                                ...
                                                <option data-countryCode="EC"
                                                    {{ old('country_code') == '593' ? 'selected' : '' }} value="593">
                                                    Ecuador (+593)</option>
                                                <option data-countryCode="EG"
                                                    {{ old('country_code') == '20' ? 'selected' : '' }} value="20">
                                                    Egypt
                                                    (+20)</option>
                                                <option data-countryCode="SV"
                                                    {{ old('country_code') == '503' ? 'selected' : '' }} value="503">El
                                                    Salvador (+503)</option>
                                                <option data-countryCode="GQ"
                                                    {{ old('country_code') == '240' ? 'selected' : '' }} value="240">
                                                    Equatorial Guinea (+240)</option>
                                                <option data-countryCode="ER"
                                                    {{ old('country_code') == '291' ? 'selected' : '' }} value="291">
                                                    Eritrea (+291)</option>
                                                <option data-countryCode="EE"
                                                    {{ old('country_code') == '372' ? 'selected' : '' }} value="372">
                                                    Estonia (+372)</option>
                                                <option data-countryCode="ET"
                                                    {{ old('country_code') == '251' ? 'selected' : '' }} value="251">
                                                    Ethiopia (+251)</option>
                                                <option data-countryCode="FK"
                                                    {{ old('country_code') == '500' ? 'selected' : '' }} value="500">
                                                    Falkland Islands (+500)</option>
                                                <option data-countryCode="FO"
                                                    {{ old('country_code') == '298' ? 'selected' : '' }} value="298">
                                                    Faroe
                                                    Islands (+298)</option>
                                                <option data-countryCode="FJ"
                                                    {{ old('country_code') == '679' ? 'selected' : '' }} value="679">
                                                    Fiji
                                                    (+679)</option>
                                                <option data-countryCode="FI"
                                                    {{ old('country_code') == '358' ? 'selected' : '' }} value="358">
                                                    Finland (+358)</option>
                                                <option data-countryCode="FR"
                                                    {{ old('country_code') == '33' ? 'selected' : '' }} value="33">
                                                    France
                                                    (+33)</option>
                                                <option data-countryCode="GF"
                                                    {{ old('country_code') == '594' ? 'selected' : '' }} value="594">
                                                    French Guiana (+594)</option>
                                                <option data-countryCode="PF"
                                                    {{ old('country_code') == '689' ? 'selected' : '' }} value="689">
                                                    French Polynesia (+689)</option>
                                                <option data-countryCode="GA"
                                                    {{ old('country_code') == '241' ? 'selected' : '' }} value="241">
                                                    Gabon
                                                    (+241)</option>
                                                <option data-countryCode="GM"
                                                    {{ old('country_code') == '220' ? 'selected' : '' }} value="220">
                                                    Gambia (+220)</option>
                                                <option data-countryCode="GE"
                                                    {{ old('country_code') == '995' ? 'selected' : '' }} value="995">
                                                    Georgia (+995)</option>
                                                <option data-countryCode="DE"
                                                    {{ old('country_code') == '49' ? 'selected' : '' }} value="49">
                                                    Germany
                                                    (+49)</option>
                                                <option data-countryCode="GH"
                                                    {{ old('country_code') == '233' ? 'selected' : '' }} value="233">
                                                    Ghana
                                                    (+233)</option>
                                                <option data-countryCode="GI"
                                                    {{ old('country_code') == '350' ? 'selected' : '' }} value="350">
                                                    Gibraltar (+350)</option>
                                                <option data-countryCode="GR"
                                                    {{ old('country_code') == '30' ? 'selected' : '' }} value="30">
                                                    Greece
                                                    (+30)</option>
                                                <option data-countryCode="GL"
                                                    {{ old('country_code') == '299' ? 'selected' : '' }} value="299">
                                                    Greenland (+299)</option>
                                                <option data-countryCode="GD"
                                                    {{ old('country_code') == '1473' ? 'selected' : '' }} value="1473">
                                                    Grenada (+1473)</option>
                                                <option data-countryCode="GP"
                                                    {{ old('country_code') == '590' ? 'selected' : '' }} value="590">
                                                    Guadeloupe (+590)</option>
                                                <option data-countryCode="GU"
                                                    {{ old('country_code') == '671' ? 'selected' : '' }} value="671">
                                                    Guam
                                                    (+671)</option>
                                                <option data-countryCode="GT"
                                                    {{ old('country_code') == '502' ? 'selected' : '' }} value="502">
                                                    Guatemala (+502)</option>
                                                <option data-countryCode="GN"
                                                    {{ old('country_code') == '224' ? 'selected' : '' }} value="224">
                                                    Guinea (+224)</option>
                                                <option data-countryCode="GW"
                                                    {{ old('country_code') == '245' ? 'selected' : '' }} value="245">
                                                    Guinea - Bissau (+245)</option>
                                                <option data-countryCode="GY"
                                                    {{ old('country_code') == '592' ? 'selected' : '' }} value="592">
                                                    Guyana (+592)</option>
                                                <option data-countryCode="HT"
                                                    {{ old('country_code') == '509' ? 'selected' : '' }} value="509">
                                                    Haiti
                                                    (+509)</option>
                                                <option data-countryCode="HN"
                                                    {{ old('country_code') == '504' ? 'selected' : '' }} value="504">
                                                    Honduras (+504)</option>
                                                <option data-countryCode="HK"
                                                    {{ old('country_code') == '852' ? 'selected' : '' }} value="852">
                                                    Hong
                                                    Kong (+852)</option>
                                                <option data-countryCode="HU"
                                                    {{ old('country_code') == '36' ? 'selected' : '' }} value="36">
                                                    Hungary
                                                    (+36)</option>
                                                <option data-countryCode="IS"
                                                    {{ old('country_code') == '354' ? 'selected' : '' }} value="354">
                                                    Iceland (+354)</option>
                                                <option data-countryCode="IN"
                                                    {{ old('country_code') == '91' ? 'selected' : '' }} value="91">
                                                    India
                                                    (+91)</option>
                                                <option data-countryCode="ID"
                                                    {{ old('country_code') == '62' ? 'selected' : '' }} value="62">
                                                    Indonesia (+62)</option>
                                                <option data-countryCode="IR"
                                                    {{ old('country_code') == '98' ? 'selected' : '' }} value="98">
                                                    Iran
                                                    (+98)</option>
                                                ...
                                                <option data-countryCode="IT"
                                                    {{ old('country_code') == '39' ? 'selected' : '' }} value="39">
                                                    Italy
                                                    (+39)</option>
                                                ...
                                                <option data-countryCode="JP"
                                                    {{ old('country_code') == '81' ? 'selected' : '' }} value="81">
                                                    Japan
                                                    (+81)</option>
                                                ...
                                                <option data-countryCode="KZ"
                                                    {{ old('country_code') == '7' ? 'selected' : '' }} value="7">
                                                    Kazakhstan (+7)</option>
                                                ...
                                                <option data-countryCode="KR"
                                                    {{ old('country_code') == '82' ? 'selected' : '' }} value="82">
                                                    Korea
                                                    South (+82)</option>
                                                ...
                                                <option data-countryCode="MY"
                                                    {{ old('country_code') == '60' ? 'selected' : '' }} value="60">
                                                    Malaysia (+60)</option>
                                                ...
                                                <option data-countryCode="MX"
                                                    {{ old('country_code') == '52' ? 'selected' : '' }} value="52">
                                                    Mexico
                                                    (+52)</option>
                                                ...
                                                <option data-countryCode="MN"
                                                    {{ old('country_code') == '95' ? 'selected' : '' }} value="95">
                                                    Myanmar
                                                    (+95)</option>
                                                ...
                                                <option data-countryCode="NL"
                                                    {{ old('country_code') == '31' ? 'selected' : '' }} value="31">
                                                ...
                                                <option data-countryCode="NZ"
                                                    {{ old('country_code') == '64' ? 'selected' : '' }} value="64">
                                                    New
                                                    Zealand (+64)</option>
                                                ...
                                                <option data-countryCode="NO"
                                                    {{ old('country_code') == '47' ? 'selected' : '' }} value="47">
                                                    Norway
                                                    (+47)</option>
                                                ...
                                                <option data-countryCode="PE"
                                                    {{ old('country_code') == '51' ? 'selected' : '' }} value="51">
                                                    Peru
                                                    (+51)</option>
                                                <option data-countryCode="PH"
                                                    {{ old('country_code') == '63' ? 'selected' : '' }} value="63">
                                                    Philippines (+63)</option>
                                                <option data-countryCode="PL"
                                                    {{ old('country_code') == '48' ? 'selected' : '' }} value="48">
                                                    Poland
                                                    (+48)</option>
                                                ...
                                                <option data-countryCode="RO"
                                                    {{ old('country_code') == '40' ? 'selected' : '' }} value="40">
                                                    Romania
                                                    (+40)</option>
                                                ...
                                                <option data-countryCode="SG"
                                                    {{ old('country_code') == '65' ? 'selected' : '' }} value="65">
                                                    Singapore (+65)</option>
                                                ...
                                                <option data-countryCode="ZA"
                                                    {{ old('country_code') == '27' ? 'selected' : '' }} value="27">
                                                    South
                                                    Africa (+27)</option>
                                                <option data-countryCode="ES"
                                                    {{ old('country_code') == '34' ? 'selected' : '' }} value="34">
                                                    Spain
                                                    (+34)</option>
                                                <option data-countryCode="LK"
                                                    {{ old('country_code') == '94' ? 'selected' : '' }} value="94">
                                                    Sri
                                                    Lanka (+94)</option>
                                                ...
                                                <option data-countryCode="SE"
                                                    {{ old('country_code') == '46' ? 'selected' : '' }} value="46">
                                                    Sweden
                                                    (+46)</option>
                                                <option data-countryCode="CH"
                                                    {{ old('country_code') == '41' ? 'selected' : '' }} value="41">
                                                ...
                                                <option data-countryCode="TH"
                                                    {{ old('country_code') == '66' ? 'selected' : '' }} value="66">
                                                    Thailand (+66)</option>
                                                ...
                                                <option data-countryCode="TR"
                                                    {{ old('country_code') == '90' ? 'selected' : '' }} value="90">
                                                    Turkey
                                                    (+90)</option>
                                                ...
                                                <option data-countryCode="VE"
                                                    {{ old('country_code') == '58' ? 'selected' : '' }} value="58">
                                                    Venezuela (+58)</option>
                                                <option data-countryCode="VN"
                                                    {{ old('country_code') == '84' ? 'selected' : '' }} value="84">
                                                    Vietnam
                                                    (+84)</option>
                                            ...
                                            <input type="text" name="mobile_no" class="form-control w-100"
                                                id="mobile_no" placeholder="Enter here...">
                                        </div>
                                            ...
                                            <tbody id="tab_logic_ip">
                                                        ...
                                                        <tr data-id={{ $key == 0 ? $key + 1 : $key }}>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter here.." name="ip[]"
                                                                    value="{{ old('ip.' . $key) }}">
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                @else
                                                                    <button type="button"
                                                                        class="btn btn-primary plus-ip btn-sm"> <i
                                                                            class="fa fa-plus"></i>
                                                                    </button>
                                                                    <button type="button"
                                                ...
                                                @else
                                                    ...
                                                    <tr data-id="1">
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button"
                                                                class="btn btn-primary  btn-sm plus-ip">
                            ...
                            <div class="form-group col-lg-12 mt-2">
                                ...
                                <a href="{{ route('wl-agent-merchant', $id) }}" class="btn btn-danger ">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        ...
        $("body").on("click", ".plus", function() {
            ...
            $("#tab_logic").append(
                ...
                i +
                '" name="wl_extra_document[' + i + '][document]">\
                                                    		                \
                                                    		            </div>\
                                                    	            </td>\
                                                    	            <td class="text-center">\
