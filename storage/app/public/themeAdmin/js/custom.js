...
(function (jQuery) {
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(".iq-sidebar-menu .active").each(function (ele, index) {
            ...
            jQuery(this).find(".iq-submenu:first").addClass("show");
            jQuery(this).find("li.active").parent("ul").addClass("show");
        });
        ...
        jQuery(".iq-sidebar-menu li.menu-level li a").click(function (
            ele,
            index
        ) {
