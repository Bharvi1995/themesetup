...
class CreateChildPayoutReportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('child_payout_reports', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('child_payout_reports');
    }
}
