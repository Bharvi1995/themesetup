...
class PayoutReportsRp extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('payout_reports_rp', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('merchant_discount_rate_master', 10, 2)->default(0)->nullable();
    ...
    {
        Schema::dropIfExists('payout_reports_rp');
    }
}
