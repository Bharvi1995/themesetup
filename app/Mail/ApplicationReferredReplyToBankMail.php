...
class ApplicationReferredReplyToBankMail extends Mailable
{
    ...
    {
        $data = $this->subject('Application Referred Reply')
            ->markdown('emails.applicationReferredReplyToBankMail')
            ->with(
                [
                    ...
                    'referred_note_reply' => $this->application_assign_to_bank->referred_note_reply,
