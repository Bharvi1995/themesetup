        ...
        if ($total_transactions >= 20) {
            ...
            if ($refund_transactions * 100 / $total_transactions >= 5) {
            	...
            	$warnings[] = [
            		...
            		'body' => 'Your MID has been temporarily suspended due to refund transactions limit. Kindly contact sales@testpay.com for further enquiry.',
            ...
            if ($chargebacks_transactions * 100 / $total_transactions >= 2) {
            	...
            	$warnings[] = [
            		...
            		'body' => 'Your MID has been temporarily suspended due to chargebacks transactions limit. Kindly contact sales@testpay.com for further enquiry.',
            ...
            if ($flagged_transactions * 100 / $total_transactions >= 10) {
            	...
            	$warnings[] = [
            		...
            		'body' => 'Your MID has been temporarily suspended due to suspicious transactions limit. Kindly contact sales@testpay.com for further enquiry.',
            ...
            if ($declined_transactions * 100 / $total_transactions >= 50) {
            	...
            	$warnings[] = [
            		...
            		'body' => 'Your MID has been temporarily suspended due to declined transactions limit. Kindly contact sales@testpay.com for further enquiry.',
