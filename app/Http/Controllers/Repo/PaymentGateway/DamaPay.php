...
use AvalanchePay\Api\Transaction as AvalanchePayTransaction;

!defined('BASE_URL') ? define('BASE_URL', 'https://www.damapay.com/') : false;

class Damapay extends Controller
{
    public $transaction;
    ...
    public function checkout($input, $check_assign_mid)
    {
        try {
            ...
            \Log::info([
                'damapay-exception' => $e->getMessage()
            ]);
    ...
    public function api(Request $request)
    {
        ...
        try {
            ...
            // Transaction Object
            $trans = new AvalanchePayTransaction();
            $trans->setAmount($amountIns)
                ->setOrderId($input['order_id']);

            // RedirectUrls Object
            $urls = new RedirectUrls();
            $urls->setSuccessUrl(route('damapay.success', $input['session_id'])) // success url
                ->setCancelUrl(route('damapay.cancel', $input['session_id'])); // cancel url
