...
class AgreementReceivedApplicationsExport
{
    protected $id;
    ...
    public function download()
    {
        ...
        return response()->streamDownload(function () use ($columns, $input) {
            ...
            $data = $data->where('applications.status', '6')->where('users.is_white_label', '0');
            ...
            fclose($file);
        }, 'Agreement_Received_Applications_Excel_' . date('d-m-Y') . '.csv');
