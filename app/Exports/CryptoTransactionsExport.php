...
class CryptoTransactionsExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithCustomValueBinder, WithMapping
{
    protected $id;
    ...
    public function collection()
    {
        ...
        $data = $data->join('middetails', 'middetails.id', 'transactions.payment_gateway_id')->where('transactions.is_transaction_type', 'CRYPTO');
    ...
    public function map($transaction): array
    {
        ...
        return [
            ...
            substr($transaction->card_no, 0, 6) . 'XXXXXX' . substr($transaction->card_no, -4, 4),
