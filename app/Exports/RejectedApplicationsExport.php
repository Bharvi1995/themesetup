...
class RejectedApplicationsExport
{
    ...
    public function download()
    {
        ...
        return response()->streamDownload(function () use ($columns, $input) {
            ...
            $data = Application::select(
                ...
                'applications.id AS application_id', // Using application_id field to generate industry type  name below
            ...
            $data = $data->where('applications.status', '3');
            ...
            fclose($file);
        }, 'Rejected_Applications_Excel_' . date('d-m-Y') . '.csv');
