...
class AdminBatchProcessingTransactionsExport implements FromCollection, WithHeadings
{
    /**
    ...
    */
    public function collection()
    {
		...
		$data = Transaction::select('transactions.order_id',
				...
				'transactions.address','transactions.customer_order_id',
		...
		$data = $data->where('transactions.is_batch_transaction', '1')
